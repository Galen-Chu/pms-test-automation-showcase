...
class HousekeepingAccountLocator(BaseLocator):
    ...
    btn_add_housekeeping = (By.XPATH, "//div[@class='e-dlg-header-content' and //child::div[text()='房務帳資料編輯']]\
                            /following-sibling::div//div[@class='sub-button--add']")
    dropdown_type = (By.XPATH, "//span[@aria-labelledby='%s_hidden']/span") # smallType # productNos
