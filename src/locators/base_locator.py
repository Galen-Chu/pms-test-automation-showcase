...
class BaseLocator:
    ...
    select_option = (By.XPATH, "(//div[@class='el-scrollbar']//span[text()='%s']/parent::li)[last()]")
    select_option_dropdownbase = (By.XPATH, "//div[contains(@class, 'dropdownbase')]//div[text()='%s']")
    select_option_dropdownbase_first_item = (By.XPATH, "//div[contains(@class, 'dropdownbase')]//div[1]")

    # span下拉選單
    select_dropdown_by_span = (By.XPATH, "//label[normalize-space()='%s']/following-sibling::span/span")
    select_option_by_combobox_item = (By.XPATH, "//div[contains(@class, 'combobox-item') and text()='%s']")

    btn_toolbar_item = (By.XPATH, "//div[@class='toolbar-list']//button[normalize-space()='%s']") #轉至住客帳 #結帳
    btn_toolbar_item_2 = (By.XPATH, "(//div/button[normalize-space()='%s'])[last()]")
    btn_toolbar_item_by_panel = (By.XPATH, "//div[@class='panel-title' and text()='%s']/parent::div\
    ...
    btn_toolbar_with_icon_by_panel = (By.XPATH, "//div[@class='panel-title' and contains(text(), '%s')]\
    ...
    text_by_dropdown_input_value = (By.XPATH, "//div[@data-field-id='%s']//span[@class='e-input-value']/span")
