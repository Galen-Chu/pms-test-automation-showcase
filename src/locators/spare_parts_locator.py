...
class SparePartsLocator(BaseLocator):
    ...
    # 明細
    spare_parts_first_row = (By.XPATH, "//tr[contains(@id,'gid') and (child::td[@field='modifyButton'])]")
    ...
    # 日期選擇
    calendar_title = (By.XPATH, "(//div[@class='calendar-title' and span[text()='Jan 2024']])[last()]")
    input_year = (By.XPATH, "(//span[text()='Jan 2024'])[last()]/ancestor::div[contains(@class,'datebox')]//input")
    select_date = (By.XPATH, "(//span[text()='Jan 2024'])[last()]/ancestor::div[contains(@class,'datebox')]//td[text()='%s']")
