...
class LostItemLocator:
    ...
    loser_name_options = (
        By.XPATH,
        "//div[contains(@class, 'combo-panel')]//tr[@datagrid-row-index='0']",
    )
    # -- 下拉選單 End --
    # -- 日期選單 --
    ...
    loser_name_field = (
        By.XPATH,
        "//label[normalize-space()='遺失者']/following-sibling::span/input[@type='text']",
    )
    # -- 欄位編輯 End --
    ...
    text_data_in_dialog = (
        By.XPATH,
        "//div[@class='panel window panel-htop']//tr[@datagrid-row-index='0']//td[@field='%s']",
    )
    # ----- 右側表格 資料顯示 End -----
