...
class ReservationCardLocator(BaseLocator):
    # ----- 訂房明細 視窗 -----
    btn_tool = (By.XPATH, "(//div[@class='e-dlg-content']//div[@data-field-id='%s']/button)[last()]")
    ...
    tab_expense_table = (By.XPATH, "(//div[@id='pane-expenseDetail']//tr[td[contains(text(),'%s')]]/td[@field='%s'])[last()]")
    tab_expense_rent = (By.XPATH, "//div[@id='pane-expenseDetail']//span[text()='房租']")
    tab_expense_list_by_date = (By.XPATH, "//div[@id='pane-expenseDetail']//tr[td[contains(text(),'%s')]]//span")
    tab_expense_summary_section = (By.XPATH, "//div[contains(@class,'expense')]//div[@data-field-id='%s']//input[@type='text']")
    ...
    btn_edit_assign_notes = (By.XPATH, "//tr[td[@field='seqNos']]//span[@class='e-btn-icon e-edit e-icons']")
    ...
    guest_name_in_table = (By.XPATH, "//div[@id='pane-guest']//tbody[not(@class)]//td[@field='altName']")
    ...
    checked_checkbox = (By.XPATH, "//input[@class='e-checkselect']/following::span[contains(@class,'e-check')]")
    # ----- 房間特色選單 視窗 End ----
    ...
    # ----- 訂房提醒彈窗 -----
    popup_reservation_remind_content = (By.XPATH, "//div[./div[text()='訂房提醒']]/following-sibling::div//textarea")
    # ----- 訂房提醒彈窗 End -----
    ...
    # ----- 公帳號相關 -----
    checkbox_use_folio = (By.XPATH, "//div[@data-field-id='masterStatus']//label[.//span[text()='使用公帳號']]//input[@type='checkbox']")
    # ----- 公帳號相關 End -----
    ...
    # ----- 關聯單號 -----
    btn_link_nos_dialog = (By.XPATH, "//div[@data-field-id='linkNosLabel']/following-sibling::div//button")
    ...
    link_nos_row_data = (By.XPATH, "//div[contains(@title, '關聯單號')]//tr[%s]//td[not(@class='text-center')]")
    text_link_nos = (By.XPATH, "//div[@data-field-id='linkNos']/div")
    text_link_nos_in_dialog = (By.XPATH, "//div/label[text()='關聯單號']/following-sibling::div/input")
    # ----- 關聯單號 End -----
